 ...
 */
class Version20180214121609 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE books (id INT AUTO_INCREMENT NOT NULL, publisher_id INT DEFAULT NULL, author_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, description VARCHAR(500) NOT NULL, cover_url VARCHAR(200) NOT NULL, isbn VARCHAR(20) NOT NULL, deleted TINYINT(1) NOT NULL, featured TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_4A1B2A922B36786B (title), INDEX IDX_4A1B2A9240C86FCE (publisher_id), INDEX IDX_4A1B2A92F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
